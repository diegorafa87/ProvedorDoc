...
import AcompanhamentoSTFC from '../components/AcompanhamentoSTFC';
import MenuLateral from '../components/MenuLateral';
import { useLocation } from 'react-router-dom';

const PaginaAcompanhamentoSTFC = () => {
    ...
    <div style={{display:'flex'}}>
      ...
      <div style={{marginLeft:200, flex:1, minHeight:'100vh', background:'#f8f9fb', padding:'2rem'}}>
        <div style={{marginTop:'40px'}}>
          <AcompanhamentoSTFC razaoSocial={razaoSocial} cnpj={cnpj} />
        </div>
      </div>
    </div>
  );
...
export default PaginaAcompanhamentoSTFC;
