...
import AcompanhamentoPostes from '../components/AcompanhamentoPostes';
import { Link } from 'react-router-dom';

export default function PaginaAcompanhamentoPostes(props) {
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div style={{maxWidth:'1100px',margin:'2rem auto',marginLeft:200,flex:1}}>
        <AcompanhamentoPostes {...props} razaoSocial={cliente.razaoSocial} cnpj={cliente.cnpj} />
      </div>
    </div>
  );
}
